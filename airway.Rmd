---
title: Analysis of the airway dataset using Swish
author: Michael Love
date: 8/1/2019
---
...
The following lines of code perform the Swish analysis on the
transcript level. The `quiet=TRUE` is just to suppress the progress
bar in the R output.
...
It's useful to examine an MA plot, where the blue points indicate an
FDR bound of 5%.
...
We can tabulate the significant transcripts at 5% FDR by the sign of
...
(with inferential replicate data shown as boxes in a boxplot):
